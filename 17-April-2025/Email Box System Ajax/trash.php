        ...
        <tr>
            ...
            <td>
                    ...
                    <table border="1">
                        ...
                        $query = "SELECT * FROM emails WHERE sender_id = '$user_id' AND status = '3'";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            ?>
                            <tr><td colspan='4'>No Email found.</td></tr>
                            <?php
                        }
                        ?>
                        <tr>
                            <td colspan="4" align="right">
                                <input type="submit" name="delete" value="Delete Selected" onclick="deleteEmail()">
                            </td>
                        </tr>
                    </table>
                </form>
