<?php
	class Database
	{
		...
		public function signUp($first_name, $last_name, $email, $password, $gender)
		{
			$this->query = "INSERT INTO user (first_name, last_name, email, password, gender) VALUES ('".$first_name."', '".$last_name."', '".$email."', '".$password."', '".$gender."')";
		...
		{
		    $this->query = "UPDATE user SET password='".$newPassword."' WHERE email='".$email."' AND password ='".$password."'";
		...
		{		
		    ...
		    $checkResult = mysqli_query($this->connection, $checkQuery) or die(mysqli_error($this->connection));
