    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDze9mww0YJ1OOFZZcb4ynMpWxulcFglgFnw&s" alt="Mac" width="200px" height="200px">
                    <h3>MacBook pro</h3>
                    <p>Price: $1000</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Macbook Pro">
                ...
                <div class="card">
                    ...
                    <p>Price: $1100</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Macbook Pro 16">
                ...
                <div class="card">
                    ...
                    <p>Price: $1200</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Macbook Air">
                ...
                <div class="card">
                    ...
                    <p>Price: $1300</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Macbook Air Pro">
