    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="card-container">
                <div class="card">    
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpoqyr_aYcU2fOo2NNhyHVoy-EraNyzzlWNA&s" alt="Ipad" width="200px" height="200px">
                    <h3>Ipad Air</h3>
                    <p>Price: $500</p>
                    <form method="POST">
                ...
                <div class="card">    
                    ...
                    <p>Price: $1000</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Ipad Air Pro">
                ...
                <div class="card">    
                    ...
                    <p>Price: $600</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Ipad 6">
                ...
                <div class="card">    
                    ...
                    <p>Price: $1500</p>
                    <form method="POST">
                        <input type="hidden" name="product" value="Ipad 8">
